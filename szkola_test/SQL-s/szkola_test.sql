...
Klasa tinyint not null, Instrument varchar(20), Nauczyciel varchar(20),
Pesel varchar(11) not null unique constraint sprawdz_pesel_uczniowie check(len(Pesel) = 11),
...
Pesel varchar(11) not null unique constraint sprawdz_pesel_pracownicy check(len(Pesel) = 11),
CzasDodania datetime2(0) default getdate())
...
Pesel varchar(11) not null unique constraint sprawdz_pesel_nauczyciele check(len(Pesel) = 11),
